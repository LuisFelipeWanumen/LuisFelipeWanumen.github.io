document.addEventListener("DOMContentLoaded", function () {
    // Datos de ejemplo
    const data = [
        { subject: 'Cálculo Diferencial', areas: ['Ciencias Básicas'], results: ['RA13'] },
        { subject: 'Cátedra Francisco José de Caldas', areas: ['Humanidades'], results: ['RA15', 'RA16', 'RA19'] },
        { subject: 'Álgebra Lineal', areas: ['Ciencias Básicas'], results: ['RA13'] },
        ...
        { subject: 'Introducción a Algoritmos', areas: ['Profesional Básica'], results: ['RA9'] },
        { subject: 'Lógica Matemática', areas: ['Ciencias Básicas'], results: ['RA13'] },
        { subject: 'Física I: Mecánica Newtoniana', areas: ['Ciencias Básicas'], results: ['RA13'] },
        { subject: 'Cálculo Integral', areas: ['Ciencias Básicas'], results: ['RA7', 'RA9', 'RA13'] },
        { subject: 'Producción y comprensión de Textos II', areas: ['Humanidades'], results: ['RA14', 'RA17'] },
        { subject: 'Administración', areas: ['Económico Administrativa'], results: ['RA14', 'RA19'] },
        { subject: 'Cátedra de Contexto', areas: ['Humanidades'], results: ['RA15', 'RA19'] },
        { subject: 'Estructura de Datos', areas: ['Profesional Básica'], results: ['RA9'] },
        { subject: 'Programación Orientada a Objetos', areas: ['Profesional Básica'], results: ['RA8'] },
        { subject: 'Contabilidad General', areas: ['Económico Administrativa'], results: ['RA18'] },
        { subject: 'Fundamentos de Organización', areas: ['Económico Administrativa'], results: ['RA14', 'RA19'] },
        ...
        { subject: 'Programación Multinivel', areas: ['Profesional Tecnología'], results: ['RA8', 'RA20'] },
        { subject: 'Bases de Datos', areas: ['Profesional Tecnología'], results: ['RA7', 'RA11'] },
        { subject: 'Matemáticas Especiales', areas: ['Ciencias Básicas'], results: ['RA12', 'RA13'] },
        { subject: 'Análisis y métodos numéricos', areas: ['Ciencias Básicas'], results: ['RA9', 'RA12', 'RA13'] },
        { subject: 'Fundamentos de Economía', areas: ['Económico Administrativa'], results: ['RA18'] },
        { subject: 'Tic_s en las organizaciones', areas: ['Económico Administrativa'], results: ['RA15'] },
        { subject: 'Ética y Sociedad', areas: ['Humanidades'], results: ['RA19'] },
        { subject: 'Programación Avanzada', areas: ['Profesional Tecnología'], results: ['RA8', 'RA20'] },
        { subject: 'Diseño Lógico', areas: ['Profesional Tecnología'], results: ['RA5'] },
        { subject: 'Transmisión de Datos', areas: ['Profesional Ingeniería'], results: ['RA5'] },
        { subject: 'Aplicaciones para Internet', areas: ['Profesional Tecnología'], results: ['RA8', 'RA20'] },
        { subject: 'Programación Web', areas: ['Profesional Tecnología'], results: ['RA8', 'RA20'] },
        { subject: 'Bases de Datos Distribuidas', areas: ['Profesional Ingeniería'], results: ['RA7', 'RA10', 'RA11'] },
        ...
        { subject: 'Análisis de Sistemas', areas: ['Profesional Tecnología'], results: ['RA8', 'RA20'] },
        { subject: 'Sistemas Operacionales', areas: ['Profesional Tecnología'], results: ['RA5'] },
        { subject: 'Taller de Investigación', areas: ['Profesional Tecnología'], results: ['RA18', 'RA19'] },
        { subject: 'Fundamentos de Telemática', areas: ['Profesional Ingeniería'], results: ['RA5'] },
        { subject: 'Protocolos de Comunicación', areas: ['Profesional Ingeniería'], results: ['RA5'] },
        { subject: 'Programación por Componentes', areas: ['Profesional Tecnología'], results: ['RA8', 'RA10', 'RA20'] },
        { subject: 'Regulación para Telecomunicaciones', areas: ['Profesional Ingeniería'], results: ['RA16', 'RA19'] },
        { subject: 'Tecnología y Medio Ambiente', areas: ['Humanidades'], results: [''] },
        { subject: 'Análisis Social Colombiano', areas: ['Humanidades'], results: [''] },
        { subject: 'Globalización', areas: ['Humanidades'], results: [''] },
        { subject: 'Informática y Sociedad', areas: ['Humanidades'], results: [''] },
        ...
        { subject: 'Tecnociencias', areas: ['Humanidades'], results: [''] },
        { subject: 'Gestión de Calidad', areas: ['Humanidades'], results: [''] },
        { subject: 'Trabajo de Grado Tecnológico', areas: ['Profesional Tecnología'], results: ['RA15', 'RA16'] },
        { subject: 'Inteligencia Artificial', areas: ['Profesional Tecnología'], results: ['RA9'] },
        { subject: 'Arquitectura de Computadores', areas: ['Profesional Tecnología'], results: ['RA5'] },
        { subject: 'Ecuaciones Diferenciales', areas: ['Ciencias Básicas'], results: ['RA9'] },
        { subject: 'Bases de Datos Avanzadas', areas: ['Profesional Tecnología'], results: ['RA7', 'RA11'] },
        { subject: 'Ingeniería de Software', areas: ['Profesional Tecnología'], results: ['RA8'] },
        { subject: 'Emprendimiento', areas: ['Económico Administrativa'], results: [''] },
        { subject: 'Tecnología y Medio Ambiente', areas: ['Humanidades'], results: [''] },
        { subject: 'Análisis Social Colombiano', areas: ['Humanidades'], results: [''] },
        { subject: 'Globalización', areas: ['Humanidades'], results: [''] },
        { subject: 'Informática y Sociedad', areas: ['Humanidades'], results: [''] },
        ...
        { subject: 'Tecnociencias', areas: ['Humanidades'], results: [''] },
        { subject: 'Gestión de Calidad', areas: ['Humanidades'], results: [''] },
        { subject: 'Cálculo Multivariado', areas: ['Ciencias Básicas'], results: ['RA1'] },
        { subject: 'Ingeniería Económica', areas: ['Económico Administrativa'], results: ['RA1', 'RA18'] },
        { subject: 'Probabilidad y Estadística', areas: ['Ciencias Básicas'], results: ['RA1'] },
        { subject: 'Sistemas Distribuidos', areas: ['Profesional Ingeniería'], results: ['RA2', 'RA3', 'RA5'] },
        { subject: 'Teoría General de Sistemas', areas: ['Profesional Ingeniería'], results: ['RA2'] },
        { subject: 'Física III: Ondas y Física Moderna', areas: ['Ciencias Básicas'], results: ['RA1', 'RA4'] },
        { subject: 'Formulación y Evaluación de Proyectos', areas: ['Económico Administrativa'], results: ['RA1', 'RA18'] },
        { subject: 'Análisis de Fourier', areas: ['Ciencias Básicas'], results: ['RA1', 'RA6'] },
        { subject: 'Redes Corporativas', areas: ['Profesional Ingeniería'], results: ['RA5'] },
        { subject: 'Sistemas Abiertos', areas: ['Profesional Ingeniería'], results: ['RA5'] },
        { subject: 'Teoría de la Información', areas: ['Profesional Ingeniería'], results: ['RA1'] },
        { subject: 'Computación Cuántica', areas: ['Profesional Ingeniería'], results: ['RA9'] },
        { subject: 'Simulación de Sistemas Dinámicos', areas: ['Profesional Ingeniería'], results: ['RA4', 'RA18'] },
        { subject: 'Criptología', areas: ['Profesional Ingeniería'], results: ['RA2', 'RA6', 'RA9'] },
        { subject: 'Investigación de Operaciones', areas: ['Ciencias Básicas'], results: ['RA18'] },
        { subject: 'Trabajo de Grado I', areas: ['Profesional Ingeniería'], results: ['RA15', 'RA16'] },
        { subject: 'Planificación y Diseño de Redes', areas: ['Profesional Ingeniería'], results: ['RA5', 'RA17', 'RA18'] },
        { subject: 'Redes de Alta Velocidad', areas: ['Profesional Ingeniería'], results: ['RA5', 'RA6'] },
        { subject: 'Seguridad en Redes', areas: ['Profesional Ingeniería'], results: [''] },
        { subject: 'Emprendimiento', areas: ['Económico Administrativa'], results: [''] },
        { subject: 'Tecnología y Medio Ambiente', areas: ['Humanidades'], results: [''] },
        { subject: 'Análisis Social Colombiano', areas: ['Humanidades'], results: [''] },
        { subject: 'Globalización', areas: ['Humanidades'], results: [''] },
        ...
        { subject: 'Tecnociencias', areas: ['Humanidades'], results: [''] },
        { subject: 'Gestión de Calidad', areas: ['Humanidades'], results: [''] },
        { subject: 'Análisis de Datos', areas: ['Profesional Ingeniería'], results: ['RA4'] },
        { subject: 'Bioinformática', areas: ['Profesional Ingeniería'], results: ['RA4'] },
        { subject: 'Gestión de Redes Telemáticas', areas: ['Profesional Ingeniería'], results: ['RA17'] },
        { subject: 'Seminario de Telemática', areas: ['Profesional Ingeniería'], results: ['RA15', 'RA18'] },
        { subject: 'Redes Inalámbricas', areas: ['Profesional Ingeniería'], results: [''] },
        { subject: 'Arquitectura Empresarial', areas: ['Profesional Ingeniería'], results: ['RA19'] },
        { subject: 'Trabajo de Grado II', areas: ['Profesional Ingeniería'], results: ['RA15', 'RA16'] },
        { subject: 'Gerencia y Auditoría en Redes', areas: ['Profesional Ingeniería'], results: [''] },
